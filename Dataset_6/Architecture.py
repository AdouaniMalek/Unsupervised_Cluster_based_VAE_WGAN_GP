...
# Source: Teboul, Alex. Kaggle, Updated 3 years ago.
...
# %%
dataset_directory = "C:/Users/Malek Adouani/Desktop/Unsupervised_Cluster_based_VAE_WGAN_GP/Dataset_6/"
df = pd.read_csv(dataset_directory + "diabetes_preprocessed.csv")
#df.head()
...
# Generate synthetic data
num_fake_samples = 20000# Number of synthetic samples to generate
...
# %%
numerical_columns = ["Age","BMI", "PhysicalHealth", "MentalHealth", "SleepTime"]
