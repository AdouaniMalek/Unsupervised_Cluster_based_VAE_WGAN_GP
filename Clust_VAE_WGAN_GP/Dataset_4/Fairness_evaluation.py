...
dataset_dir = "C:/Users/Mega Pc/Desktop/SF-GAN unsupervised/Dataset_4/Artificial_samples/"
file_path = os.path.join(dataset_dir, 'gen_samp_WO_Adv_deb_epsilon117.77.csv')
df = pd.read_csv(file_path)
# Load the original dataset to retrieve scaling information for 'Age'
dfo = pd.read_csv("C:/Users/Mega Pc/Desktop/SF-GAN unsupervised/Dataset_4/heart_failure_clinical_records_dataset.csv")
...
num_clusters = 40 # Adjust the number of clusters as needed
