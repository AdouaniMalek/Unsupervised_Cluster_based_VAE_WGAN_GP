...
# Source: Marcinkevičs et al., Zenodo, 2023
# DOI: https://doi.org/10.5281/zenodo.7669442
...
# %%
dataset_directory = "C:/Users/Malek Adouani/Desktop/Unsupervised_Cluster_based_VAE_WGAN_GP/Dataset_5/"
df = pd.read_csv(dataset_directory + "Regensburg_Pediatric_Preprocessed.csv").drop(['Unnamed: 0'],axis=1)
#df.head()
...
# %%
# Number of clusters
num_clusters = 10  # Define the number of clusters for K-means
...
num_clusters = 10  # Adjust based on your clustering requirements
...
gen_samples_df.to_csv(dataset_directory + "Artificial_samples/"+f"gen_samp_rho{rho:.2f}_epsilon{epsilon:.2f}.csv")
