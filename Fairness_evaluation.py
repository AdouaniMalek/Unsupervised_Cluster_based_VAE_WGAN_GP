...
dataset_dir = "C:/Users/Mega Pc/Desktop/SF-GAN unsupervised/Dataset_1/"
file_path = os.path.join(dataset_dir, 'gen_samp_WO_Adv_Deb_Epsilon_189.48.csv')
df = pd.read_csv(file_path).drop('Unnamed: 0',axis=1)
# Load the original dataset to retrieve scaling information for 'Age'
dfo = pd.read_csv("C:/Users/Mega Pc/Desktop/SF-GAN unsupervised/Dataset_1/HealthGymV2.csv")
...
protected_attributes = ['Ethnic_2.0', 'Ethnic_3.0', 'Ethnic_4.0', 'Gender']
...
features = df.drop(columns=protected_attributes)  # Exclude sensitive attributes
