...
gen_samples_df.to_csv("Artificial_samples/"+f"gen_sampWO_Adv_deb_epsilon{epsilon:.2f}.csv", index=False)


# %%
f"gen_sampWO_Adv_deb_epsilon{epsilon:.2f}.csv"
