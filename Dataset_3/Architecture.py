...
# %%
dataset_directory = "C:/Users/Malek Adouani/Desktop/Unsupervised_Cluster_based_VAE_WGAN_GP/Dataset_3/"
...
# %%
def ConVAE_cluster_loss(x_recon, x_orig, mu, logvar, z, cluster_centroids, alpha=0.5,beta =0.1):
    # Reconstruction loss
...
# Generate synthetic data
num_fake_samples = 2087 # Number of synthetic samples to generate
